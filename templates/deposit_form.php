                     ...
                     <div class="row" style="margin:0px;" >
                        ...
                        <nav class="horizontal-menu">
                             <ul style="margin-left:0px; padding:0px;">
                                ...
                                <li><a href="deposit.php"><h2 style="color:#52001D; font-size:33px;font-weight:bold;">deposit</h2></a></li>
                    ...
                    <form action="deposit.php" method="POST" >
                            <fieldset>
                                <div class="input-control text" data-role="input-control">
                                    <input id="depositInput" type="text" placeholder="Deposit Amount" name="deposit" autofocus>
                                 ...
                                 <div class="toolbar transparent" style=" font-size:25px; margin-top:20px;">                               
                                    <button type="submit" id="btn">
                                            ...
                                            <i class="fa fa-money fa-2x fa-hover fg-darkGreen ">Deposit</i>
